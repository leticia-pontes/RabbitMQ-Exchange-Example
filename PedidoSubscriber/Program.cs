...
consumer.Received += async (model, ea) =>
{
    ...
    var url = "http://localhost:5179/api/pedido";
    ...
    {
        Console.WriteLine("✅ Pedido enviado para API com sucesso.");
    }
    else
    {
        Console.WriteLine("❌ Falha ao enviar pedido para API.");
    }
};
